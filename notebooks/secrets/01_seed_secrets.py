...
# Drop any previously-imported copy so a fresh `git pull` is picked up without a
# cluster restart (Databricks caches imported modules across notebook re-runs).
